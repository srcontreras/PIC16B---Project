...
One of our biggest problems at the beginning of the project was figuring out how we were going to find news articles about Starbucks. Our project idea initially was to see how Twitter (now known as X) affects stock prices; however, Twitter had just changed their API policies, limiting non-paying users to only 1000 tweets per month, which would be pretty much useless for us. We looked at other APIs such as NewsData.io, but they also required us to pay to get an API key. What we settled on was using Good News Network to use as positive news articles. We could also search Good News Network for articles specific to Starbucks 
